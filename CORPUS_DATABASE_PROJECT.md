...
| `output/pdfs/` | 49 downloaded Justel consolidated PDFs (59 MB total, stored on OneDrive junction) | [output/pdfs/](output/pdfs/) |
...
The database consists of three tables. All output files are OneDrive-synced via the existing `output/` junction.
...
│
├── output/                            ← Symlink/junction to OneDrive
